...
const Avatar = ({ src, name, size = "md", className = "", status, onClick }) => {
  ...
  return (
    <div
      className={`relative shrink-0 ${onClick ? "cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500/50 focus-visible:ring-offset-2 focus-visible:ring-offset-navy-800 rounded-full" : ""}`}
      onClick={onClick}
