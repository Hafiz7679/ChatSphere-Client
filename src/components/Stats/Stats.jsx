...
const stats = [
  { icon: <MessageCircle />, value: "Real-Time", title: "Messaging", description: "Instant communication powered by Socket.IO." },
  { icon: <Users />, value: "Multi User", title: "Conversations", description: "Chat with multiple users seamlessly." },
  { icon: <Zap />, value: "<100ms", title: "Fast Response", description: "Optimized backend for lightning-fast performance." },
  { icon: <Shield />, value: "100%", title: "Secure Login", description: "JWT authentication keeps your account protected." },
];
