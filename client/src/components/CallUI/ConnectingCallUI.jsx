const ConnectingCallUI = ({ userName, callType, onCancel }) => {
  return (
    <div className="fixed inset-0 z-50 bg-navy-950 flex flex-col items-center justify-center">
      ...
      <p className="text-surface-400 text-sm mb-12">
        Connecting{callType === "video" ? " video" : ""}...
      </p>

      <div className="flex items-center justify-center gap-2 mb-12">
        <div className="w-8 h-8 border-[3px] border-surface-700/50 border-t-brand-500 rounded-full animate-spin" />
      </div>
...
export default ConnectingCallUI;